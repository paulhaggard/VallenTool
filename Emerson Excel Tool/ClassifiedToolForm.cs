...
namespace Emerson_Excel_Tool
{
    public partial class ToolForm : Form
    {
        ...
        ExcelProcess excelProcessObjectInstance = new ExcelProcess();
        // Create an object for the Dataset - a memory buffer for datatables
        DataSet_Processing datasetObjectInstance = new DataSet_Processing();
        ...
        {
            // When the form loads, go ahead and launch Excel.
            excelProcessObjectInstance.Launch();
        ...
        {
            excelProcessObjectInstance.LoadDatagrid(out DataTable dt);
            datasetObjectInstance.listOfDataSets = ExcelProcess.listOfDataSets;
            datasetObjectInstance.listOfDataSets.ElementAt<DataSet_Processing>(0).GetTableData(out dt);
        ...
        private void runExcelBtn(object sender, System.EventArgs e)
        {
            SetFileToProcess();
            excelProcessObjectInstance.Launch();
            excelProcessObjectInstance.ProcessFilesinExcel();
            EmptyTheFileList();
        }
        ...
        {
            excelProcessObjectInstance.Close();
        }
        ...
        public class DataSet_Processing
        {
            ...
            public DataSet_Processing()  //initializes an instance of the class
            {
                ...
                DataSet datasetName = _vallenLogs;

            }

            public List<DataSet_Processing> listOfDataSets { get; set; }
        ...
        /// <summary>
        /// This class connects Excel to the Emerson Tool.  It contains all properties and methods required for interconnection.
        /// </summary>
        public class ExcelProcess
        {
            ...
            public static List<DataSet_Processing> listOfDataSets { get; set; }


            /// <summary>
            /// CTOR defaults: Verify/launch Excel, open/create WB, open/create Sheet
            /// </summary>
            public ExcelProcess()
            {
            ...
            /// <summary>
            /// Check if Excel is launched, or Launch as needed.
            /// Includes file creation, emptying.
            /// </summary>
            public void Launch()
            {
            ...
            {
                MessageBox.Show(listOfDataSets.Count.ToString());
                MessageBox.Show(listOfDataSets.ElementAt(0).ToString());
                MessageBox.Show(listOfDataSets.ElementAt(0).tableName);
                DataTable dt_int = new DataTable();
                string[,] results = new string[dt_int.Rows.Count, dt_int.Columns.Count];
                listOfDataSets.ElementAt<DataSet_Processing>(0).GetTableData(out dt_int, out results);
                dt = dt_int;
